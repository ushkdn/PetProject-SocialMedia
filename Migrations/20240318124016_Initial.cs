    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGroups", x => new { x.FollowersId, x.GroupsId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_UserGroups_Users_FollowersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserJoinRequests", x => new { x.JoinRequestsId, x.SentGroupJoinRequestsId });
                    table.ForeignKey(
                        name: "FK_UserJoinRequests_Groups_SentGroupJoinRequestsId",
                        column: x => x.SentGroupJoinRequestsId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserJoinRequests_Users_JoinRequestsId",
                        column: x => x.JoinRequestsId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserJoinRequests_SentGroupJoinRequestsId",
                table: "UserJoinRequests",
                column: "SentGroupJoinRequestsId");
        }
